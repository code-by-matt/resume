...
\textbf{Seam Carving} \hfill April 2019
\begin{itemize}
	\item Class project to implement an image resizing algorithm that preserves the image's content without cropping or stretching.
	\item Tools: Java.
\end{itemize}
...
\begin{itemize}
	\item Java, Python, HTML/CSS, JavaScript.
	\item Django.
\end{itemize}
